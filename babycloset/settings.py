"""
Django settings for babycloset project.
...
ALLOWED_HOSTS = ['gdgdbaby212.pythonanywhere.com', '127.0.0.1', 'localhost']
...
WSGI_APPLICATION = 'babycloset.wsgi.application'
